...
class DateTimeTransforms:
    ...
    def to_datetime_str(my_date_time) -> str:
        ...
        """
        return (my_date_time.strftime(DateTimeTransforms.DEFAULT_DATETIME_FORMAT_FORMAT))
    ...
    def to_short_time_str(my_date_time) -> str:
        ...
        """
        return (my_date_time.strftime(DateTimeTransforms.DEFAULT_SHORT_TIME_FORMAT_FORMAT))
    ...
    def to_short_datetime_str(my_date_time) -> str:
        ...
        """
        return (my_date_time.strftime(DateTimeTransforms.DEFAULT_SHORT_DATETIME_FORMATDATE_FORMAT))


if __name__ == "__main__":
    print(DateTimeTransforms.DEFAULT_TIME_FORMAT)
    print(DateTimeTransforms.DEFAULT_DATE_FORMAT)
    print(DateTimeTransforms.DEFAULT_SHORT_TIME_FORMAT)
    print(DateTimeTransforms.DEFAULT_DATETIME_FORMAT)
    print(DateTimeTransforms.DEFAULT_SHORT_DATETIME_FORMAT)
